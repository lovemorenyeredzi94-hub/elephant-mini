...
module.exports = {
    ...
    ownerNumber: ['263782313021'], // Add your number without + or spaces (e.g., 263782313021)
    ownerName: ['Mr Elephant'], // Owner names corresponding to ownerNumber array
    
// Bot Configuration
    botName: 'Elephant MD', // ← Optional: Update bot name too
    prefix: ',',
    sessionName: 'session',
