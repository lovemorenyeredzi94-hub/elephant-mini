...
module.exports = {
    ...
    execute: async (conn, message, m, { from, isGroup, reply }) => {
        try {
            const url = 'https://api.princetechn.com/api/anime/hwaifu?apikey=prince';
            ...
            console.error('[hwaifu] error:', error);
            ...
            if (error.response?.status === 404) {
                ...
                await reply(`❌ Failed to fetch hwaifu image: ${error.message}`);
            }
        }
    }
};