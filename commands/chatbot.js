...
async function getAIResponse(userMessage, userContext) {
    ...
    const prompt = [
        `You are QADEER-XD MINI. You are a real WhatsApp user—not an AI or assistant. Chat naturally like a real person.`,
        ...
        'Mirror the user\'s energy. If they joke, joke back. If they roast you, roast them back with witty, playful comebacks.',
...
module.exports = {
    ...
    // Export handleChat for external use
    handleChat
};