...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      const displayOwner = ownerNames[0]  || 'Mr Elephant';
      
      let menuText = `╭━━『 *ELEPHANT-MD* 』━━╮\n\n`;
      ...
      const imagePath = path.join(__dirname, 'https://files.catbox.moe/ed0968.jpg';
        ...
        await sock.sendMessage(extra.from, {
          ...
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              newsletterJid: config.newsletterJid '120363426745883545@newsletter',
