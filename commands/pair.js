...
module.exports = {
    pattern: "pair",
    desc: "Connect your WhatsApp to ELEPHANT-MD for enhanced features",
    react: "💓",
    category: "utility",
    filename: __filename,
    ...
    execute: async (conn, mek, m, { from, args, q, reply }) => {
        ...
        try {
            ...
            const pairingMessage = `🔑 *ᴇʟᴇᴘʜᴀɴᴛ-ᴍᴅ Pairing Instructions* 🔑\n\n` +
                                `🌐 *Pairing Link:* https://elephant-mini.onrender.com\n\n` +
                                `📋 *How to connect:*\n` +
