...
module.exports = {
    ...
    execute: async (conn, message, m, { from, isGroup, reply }) => {
        try {
            const url = 'https://api.princetechn.com/api/anime/konachan?apikey=prince';
            ...
            console.error('[konachan] error:', error);
            ...
            if (error.response?.status === 404) {
                ...
                await reply(`❌ Failed to fetch konachan image: ${error.message}`);
            }
        }
    }
};