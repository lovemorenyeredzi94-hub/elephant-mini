module.exports = {
    ...
    execute: async (conn, message, m, { from, isGroup, reply, sender }) => {
            ...
            return await conn.sendMessage(from, {
                ...
                contextInfo: {
                    ...
                    externalAdReply: {
                        ...
                        body: "/",
                        thumbnailUrl: "https://files.catbox.moe/ed0968.jpg", // Replace with your image URL
                        sourceUrl: "https://elephant-mini.onrender.com",      // Replace with your repo link
                        mediaType: 1,
        ...
        try {
            ...
            await sendFancyReply(` Error fetching JID:\n${e.message}`);
        }
    }
};